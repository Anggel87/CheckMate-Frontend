...
export const CAREER_DIRECTOR_MENU: NavigationItem[] = [
  ...
  { label: 'Estadísticas', icon: 'fa-solid fa-chart-line', route: '/director/statistics', permission: 'statistics.view' },
  { label: 'Emergencias', icon: 'fa-solid fa-shield-halved', route: '/director/emergencies', permission: 'emergencies.view' },
];
