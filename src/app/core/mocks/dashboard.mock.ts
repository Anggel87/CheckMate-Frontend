...
export const DASHBOARD_METRICS_BY_ROLE: Record<UserRole, DashboardMetric[]> = {
  ...
  [UserRole.CAREER_DIRECTOR]: [
    ...
    },
    {
      ...
      value: '93%',
      description: 'Promedio de carrera',
  ...
  [UserRole.TEACHER]: [
    ...
    },
    {
      ...
      value: '94%',
      description: 'Promedio de grupos',
  ...
  [UserRole.TUTOR_TEACHER]: [
    {
      ...
      value: '34',
      description: 'Grupo asignado',
      icon: 'fa-solid fa-user-group',
      tone: 'info',
    },
    {
      title: 'Faltas recurrentes',
      value: '6',
